 ...
 */
    class Connection {
         ...
         */
        function __construct($hostname = 'localhost', $database = 'db', $user = 'root', $password = '') {
    ...
    class View
    {
        ...
        public function getListFiles($conn, $id)
        {
            ...
            while ($row = $res->fetch(PDO::FETCH_NUM)){
                ...
                $response .= "<li $class>";
                $response .=  "#$row[0] - <a href='/view.php?id=$row[0]'>$row[1]</a> <img src='images/loader.gif' alt='loader'/>";
                $response .=  '</li>';
            }
            return $response;
        }
